...
export default defineTool({
  description:
    "Requests approval to discard a proposed invoice that will not be recorded. Use when the person says the invoice is wrong, duplicated, or that they do not want it. The draft entries are removed and the batch is marked as rejected, so it stops showing up as pending. Saying in the chat that it was discarded does NOT discard it: without this call the draft stays alive and comes back in the ledger snapshot every turn.",
